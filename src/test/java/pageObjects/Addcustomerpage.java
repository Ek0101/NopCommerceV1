...
public class Addcustomerpage {
	...
	By lstitemForumModerators = By.xpath("//span[normalize-space()='Forum Moderators']");
	...
	public void setCustomerRoles(String role) throws InterruptedException { if
	  (!role.equals("Vendors")) { // PROBLEM!!!!!!!!!!!!---->solved
	  ...
	  if (role.equals("Administrators")) { listitem =
	  ldriver.findElement(lstitemAdministrators); } 
	  else if (role.equals("Guest"))
	  { listitem = ldriver.findElement(lstitemGuests); } 
	  else if
	  (role.equals("Registered")) { listitem =
	  ldriver.findElement(lstitemRegistered); } 
